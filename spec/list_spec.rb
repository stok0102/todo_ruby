...
describe(List) do
  ...
  describe("#tasks") do
    it "returns an array of tasks for that list" do
      test_list = List.new({:name => "Epicodus stuff", :id => nil})
      test_list.save()
      test_task = Task.new({:description => "Learn SQL", :list_id => test_list.id(), :due_date => '2016-07-12'})
      test_task.save()
      test_task2 = Task.new({:description => "Review Ruby", :list_id => test_list.id(), :due_date => '2016-07-12'})
      test_task2.save()
  ...
  describe("#update") do
    it "lets up update lists in the database" do
      list = List.new({:name => "Epicodus stuff", :id => nil})
      list.save()
  ...
  describe("#delete") do
    ...
    it("deletes a list's tasks from the database") do
      list = List.new({:name => "Epicodus stuff", :id => nil})
      list.save()
      task = Task.new({:description => "learn SQL", :list_id => list.id(), :due_date => '2016-07-12'})
      task.save()
      task2 = Task.new({:description => "Review Ruby", :list_id => list.id(), :due_date => '2016-07-12'})
      task2.save()
      list.delete()
